    ...
    design_structure: function(frm, cdt, cdn) {
        ...
        (async () => {
            try {
                ...
                // --- Load previously entered parameters if available ---
                let previous_params = {};
                ...
                let dialog_fields = [
                    ...
                    { label: 'Qty', fieldname: 'qty', fieldtype: 'Float', default: previous_params.qty || 1 },
                    { label: 'Weight Approx (Kg)', fieldname: 'weight_approx', fieldtype: 'Float', read_only: 1, default: previous_params.weight_approx || 0 }
                ];
                ...
                const update_weight = () => {
                    ...
                    let qty_input = parseFloat(d.get_value('qty')) || 1;
                    let weight = 0;

                    const find_field = (keywords) => {
                        keywords = Array.isArray(keywords) ? keywords : [keywords];
                        let field = critical_fields.find(f =>
